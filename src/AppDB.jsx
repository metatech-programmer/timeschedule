...
function App() {
  ...
  return (
    <>
      <InstallApp />
      <div className="min-h-screen bg-gradient-to-t from-secondary-blue-app to-background-app   px-8 pt-8 flex flex-col items-center md:hidden ">
        <h1 className="text-4xl font-bold text-primary-orange-app mb-8 text-center">
        ...
        <div className="border-b my-3 w-full">
